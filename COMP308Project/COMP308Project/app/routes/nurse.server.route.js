...
module.exports = function (app) {
    ...
    app.get('/nurse/viewPatientInfo', nurse.readHealthData)  //view patient health data
    app.post('/nurse/newPatientInfo', nurse.createHealthData)   //creates new patient health data
   ...
   app.route('/nurses/:patientID')
    ...
    app.route('/nurses/motivation')*/
       app.get('/nurse/motivation',nurse.listQuotes)
        app.post('/nurse/motivation',nurse.createQuote); 
};
